...
var door11_locked = false
var door12_locked = false

func _on_door_1_trigger_body_entered(_body):
	door11_locked = true
	check_and_play_animation()

func _on_door_trigger_12_body_entered(_body):
	door12_locked = true
	check_and_play_animation()

func check_and_play_animation():
	if door11_locked and door12_locked:
